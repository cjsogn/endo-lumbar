# Purpose: Execute analysis stages in dependency order.
# Inputs: Code package, authorised registry export and a separate private workspace.
# Outputs: Stage outputs, package-version records and execution logs.
...
required <- c(
  "brms", "posterior", "haven", "cmdstanr", "dplyr", "tidyr", "tibble",
...
Sys.unsetenv(c(
  "ENDO_MODEL_WORKER", "ENDO_CHAIN_CORES", "ENDO_LOAD_ONLY",
  "ENDO_MANIFEST", "ENDO_SCRIPT", "ENDO_BATCH"
))
stages <- c(
  "01_import_registry.R", "01_prepare_data.R", "02_fit_primary.R",
  ...
  "12_finalize_result_tables.R", "13_descriptive_analyses.R", "14_exploratory_analyses.R"
)
